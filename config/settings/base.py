...
API_VERSION = "v1"
POLLING_INTERVAL_MS = int(os.getenv("POLLING_INTERVAL_MS", "2000"))
...
AI_DUPLICATE_WINDOW_SECONDS = int(os.getenv("AI_DUPLICATE_WINDOW_SECONDS", "10"))
...
AI_CHAT_RECENT_TURNS = int(os.getenv("AI_CHAT_RECENT_TURNS", "3"))
AI_TTL_DELETE_BATCH_SIZE = int(os.getenv("AI_TTL_DELETE_BATCH_SIZE", "500"))
AI_PREVIEW_RETENTION_DAYS = int(os.getenv("AI_PREVIEW_RETENTION_DAYS", "7"))
# 채팅 결과에는 코치의 수정 제안 전문이 들어 있어 대화와 같은 기간 동안 보관한다.
AI_CHAT_PAYLOAD_RETENTION_DAYS = int(os.getenv("AI_CHAT_PAYLOAD_RETENTION_DAYS", "30"))
...
AI_CONTRIBUTION_MAX_COMMENTS = int(os.getenv("AI_CONTRIBUTION_MAX_COMMENTS", "500"))
AI_CONTRIBUTION_MAX_CHARS = int(os.getenv("AI_CONTRIBUTION_MAX_CHARS", "50000"))
BRAINSTORM_NOTE_MAX_LENGTH = int(os.getenv("BRAINSTORM_NOTE_MAX_LENGTH", "4000"))
